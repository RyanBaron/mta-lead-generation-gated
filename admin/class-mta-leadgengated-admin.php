  ...
  public function print_help_section_gravity_form() {
    ...
    print '
      <ol class="help-list">
        ...
        <li>' . __('* Add a name field to the form.  For the name field, Under the appearance tab add the class "gated-name".', 'mta-leadgengated') . ' <a data-screenshot-url="'.$plugins_url.'/mta-leadgengated/admin/img/gravity-form-name-field.jpg" class="help-screenshot" href="#">View Screenshot</a><div class="screenshot-wrapper"><a href="#" class="hide-screenshot"><span>Close</span> &times;</a></div></li>
        <li>' . __('* Add a company field (standard input field) to the form.  For the company field, Under the appearance tab add the class "gated-company".', 'mta-leadgengated') . ' <a data-screenshot-url="'.$plugins_url.'/mta-leadgengated/admin/img/gravity-form-company-field.jpg" class="help-screenshot" href="#">View Screenshot</a><div class="screenshot-wrapper"><a href="#" class="hide-screenshot"><span>Close</span> &times;</a></div></li>
        <li>' . __('* Add a email field to the form.  For the email field, Under the appearance tab add the class "gated-email".', 'mta-leadgengated') . ' <a data-screenshot-url="'.$plugins_url.'/mta-leadgengated/admin/img/gravity-form-company-field.jpg" class="help-screenshot" href="#">View Screenshot</a><div class="screenshot-wrapper"><a href="#" class="hide-screenshot"><span>Close</span> &times;</a></div></li>
        <li>' . __('* Add a phone field to the form.  For the phone field, Under the appearance tab add the class "gated-phone".', 'mta-leadgengated') . ' <a data-screenshot-url="'.$plugins_url.'/mta-leadgengated/admin/img/gravity-form-company-field.jpg" class="help-screenshot" href="#">View Screenshot</a><div class="screenshot-wrapper"><a href="#" class="hide-screenshot"><span>Close</span> &times;</a></div></li>
